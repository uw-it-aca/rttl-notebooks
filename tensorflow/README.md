...
│   ├── astropy-iers-data [required: >=0.2024.10.28.0.34.7, installed: 0.2026.6.22.1.23.34]
...
astroml==1.0.2.post1
  ...
  │     ├─ __glibc [required: >=2.17,<3.0.a0]
  │     ├─ astropy-iers-data 0.2026.6.22.1.23.34 [required: >=0.2024.10.28.0.34.7]
