...
### Changed
- Updated base image to use tag `hub-5.5.1` to match Hub version.
- Updated RStudio Server Version to v2026.08.2+200
...
- Updated RStudio Server to v2026.05.0+218
...
- Updated RStudio to v2025.09.1+401
