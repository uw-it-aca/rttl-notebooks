...
- `docker run -p 8888:8888 us-west1-docker.pkg.dev/uwit-mci-axdd/rttl-images/jupyter-rstudio-notebook:2.7.1`
...
- `docker run -it --entrypoint /bin/bash us-west1-docker.pkg.dev/uwit-mci-axdd/rttl-images/jupyter-rstudio-notebook:2.7.1`
...
│   └── six [required: Any, installed: 1.16.0]
├── grpcio [required: >=1.24.3,<2.0, installed: 1.70.0]
...
│   │   └── typing_extensions [required: >=4.5.0, installed: 4.11.0]
│   ├── packaging [required: Any, installed: 24.2]
...
│   ├── grpcio [required: >=1.48.2, installed: 1.70.0]
...
├── typing_extensions [required: >=3.6.6, installed: 4.11.0]
